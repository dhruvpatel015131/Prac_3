...
namespace Prac_3Ex
{
    ...
    partial void Deleteemp_info(emp_info instance);
		...
		public DataClasses1DataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["ExConnString"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnenmaeChanging(string value);
    partial void OnenmaeChanged();
    ...
    partial void OnsalaryChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_enmae", DbType="VarChar(50)")]
		public string enmae
		{
			get
			{
			...
			set
			{
				if ((this._enmae != value))
				{
					this.OnenmaeChanging(value);
					this.SendPropertyChanging();
					this._enmae = value;
					this.SendPropertyChanged("enmae");
					this.OnenmaeChanged();
				}
			}
		}
