<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeInfoDisconnectedArchitecture.aspx.cs" Inherits="Prac_3Ex.EmployeeInfoDisconnectedArchitecture" %>
...
<body>
    <form id="form1" runat="server">
        <div>
             <center>
                <h3> <asp:Label ID="Label1" runat="server" Text="Employee Information Disconnected Architecture"></asp:Label></h3>
            </center>
